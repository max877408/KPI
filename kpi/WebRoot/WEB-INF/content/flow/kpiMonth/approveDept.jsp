...
<html lang="en">
	...
	<body>
		<form id="inputForm" action="${ctx }/snaker/flow/process" method="post" target="mainFrame">
			...
			<iframe src="../../pkpi/deptkpiWF.html?processId=${processId }&orderId=${orderId }&taskId=${taskId }&taskName=apply" frameborder="0" style="width:100%;height:100%"></iframe>
